...
const Slider = () => {
    ...
    return (
        <div style={{ backgroundImage: `url(${img1})` }} className="">
            <div className='grid px-5 grid-cols-1 md:grid-cols-2 w-full justify-center items-center h-96'>
                ...
                <div className='flex md:block hidden items-end w-full justify-end'>
                    <img className='h-96 flex justify-end ml-60 py-4 w-96' src={img2} alt="" />
                </div>
            </div>
        </div>
    );
